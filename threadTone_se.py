...
# Parameter
imgPath = "./path"  
imgRadius = 944     # Number of pixels that the image radius is resized to

initPin = 0         # Initial pin to start threading from 
nPins = 198         # Number of pins on the circular loom
...
if __name__=="__main__":
    ...
    for line in range(nLines):
        ...
        #print 'oldPin ' + str(oldPin)
        #print 'oldCoord ' + str(oldCoord)
    ...
    pather = lambda d : '<path d="%s" stroke="black" stroke-width="1" fill="none" />\n' % d
    pathstrings=[]
